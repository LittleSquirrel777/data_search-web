...
export default {
  ...
  methods: {
    ...
    GeneResult: function() {
      const url = this.baseUrl + '/files/homoExec'
    ...
    gpuCom: function() {
      const url = this.baseUrl + '/files/gpuCom'
      axios.get(url).then(response => {
        console.log(response.data.data)
        this.result = response.data.data
        this.resultList = this.resultList.concat(this.result)
...
<template>
  <div class="box">
    ...
    <div class="button-item1">
      <el-scrollbar>
        <el-dropdown>
          <el-button type="success" @click="GeneResult()">计算结果</el-button>
        </el-dropdown>
      </el-scrollbar>
    </div>
    ...
    <div class="button-item2">
      <el-scrollbar>
        <el-dropdown>
          <el-button type="success" @click="gpuCom()">gpu加速展示</el-button>
        </el-dropdown>
      </el-scrollbar>
    </div>
